package com.home.service.whatuwant;
...
import com.home.service.whatuwant.Prevalent.Prevalent;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void AllowAccessToUser(final String myphone, final String mypassword) {
        ...
        if(Phone.getText().toString().equals("8668221572")&&Password.getText().toString().equals("admin01"))
        {
            LoadingBar.dismiss();
